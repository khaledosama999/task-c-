...
public:
	...
	void DrawIORead(Point Left, int width, int height, string Text, bool Selected = false);
	void DrawIOWrite(Point Left, int width, int height, string Text, bool Selected = false);
